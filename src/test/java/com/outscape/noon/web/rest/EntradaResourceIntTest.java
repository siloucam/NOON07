...
import com.outscape.noon.service.EntradaService;
...
import com.outscape.noon.service.dto.EntradaCriteria;
import com.outscape.noon.service.EntradaQueryService;
...
public class EntradaResourceIntTest {
    ...
    @Autowired
    private EntradaSearchRepository entradaSearchRepository;
    ...
    public void initTest() {
        entradaSearchRepository.deleteAll();
    ...
    public void createEntrada() throws Exception {
        ...
        Entrada entradaEs = entradaSearchRepository.findOne(testEntrada.getId());
        assertThat(entradaEs).isEqualToIgnoringGivenFields(testEntrada);
    }
    ...
    public void deleteEntrada() throws Exception {
        ...
        boolean entradaExistsInEs = entradaSearchRepository.exists(entrada.getId());
        assertThat(entradaExistsInEs).isFalse();
