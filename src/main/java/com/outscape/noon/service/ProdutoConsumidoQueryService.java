...
public class ProdutoConsumidoQueryService extends QueryService<ProdutoConsumido> {
    ...
    public ProdutoConsumidoQueryService(ProdutoConsumidoRepository produtoConsumidoRepository, ProdutoConsumidoSearchRepository produtoConsumidoSearchRepository) {
